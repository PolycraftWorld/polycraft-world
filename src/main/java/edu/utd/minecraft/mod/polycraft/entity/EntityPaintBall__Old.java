...
public class EntityPaintBall__Old extends EntityPellet__Old{
	...
	ItemSlingshot__Old.SlingshotType type;
	public boolean isChildPellet = false, createdChildren = false;
	private World world;
	
	private static double SCATTER_SPLIT_DEGREE = 10.0;
	
	public EntityPaintBall__Old(World world) {
		super(world);
		this.world = world;
	}
	
	public EntityPaintBall__Old(World world, EntityPlayer shootingEntity, float float1, ItemSlingshot__Old.SlingshotType type) {
