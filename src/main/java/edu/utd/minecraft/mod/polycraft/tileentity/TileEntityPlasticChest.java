...
public class TileEntityPlasticChest extends TileEntity implements IInventory
{
    private ItemStack[] chestContents = new ItemStack[36];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityPlasticChest adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityPlasticChest adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityPlasticChest adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityPlasticChest adjacentChestZPos;
    ...
    public TileEntityPlasticChest(int par1)
    {
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "container.plasticchest";
    }
    ...
    private void func_145978_a(TileEntityPlasticChest p_145978_1_, int p_145978_2_)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityPlasticChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityPlasticChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityPlasticChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityPlasticChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        return block instanceof BlockPlasticChest && ((BlockPlasticChest)block).field_149956_a == this.func_145980_j();
    }
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockPlasticChest))
            {
                return 0;
            }

            this.cachedChestType = ((BlockPlasticChest)this.getBlockType()).field_149956_a;
        }
