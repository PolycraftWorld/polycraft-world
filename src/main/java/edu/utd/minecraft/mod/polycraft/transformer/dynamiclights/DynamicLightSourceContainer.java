 ...
 * 
 *         Container class to keep track of IDynamicLightSource instances. Remembers their last position and calls World updates if they move.
 * 
 */
public class DynamicLightSourceContainer
{
	...
	/**
	 * Update passed on from the World tick. Checks for the Light Source Entity to be alive, and for it to have changed Coordinates. Marks it's current Block for Update if it has moved. When this method returns true, the Light Source Entity
	 * has died and it should be removed from the List!
	 * 
	...
	/**
	 * Checks for the Entity coordinates to have changed. Updates internal Coordinates to new position if so.
	 * 
