...
public class MeroxTreatmentUnitRecipeHandler extends TemplateRecipeHandler {

	public static final int[][] INPUT_POS = { { 3, 7 }, { 21, 7 }, { 39, 7 } };

	public class MeroxTreatRecipe extends CachedRecipe {
		...
		public MeroxTreatRecipe(PolycraftRecipe recipe) {
			...
			buckets.add(new PositionedStack(new ItemStack(Items.water_bucket), 66, 7));
			buckets.add(new PositionedStack(new ItemStack(Items.water_bucket), 66, 43));
		}
	...
	public void loadTransferRects() {
		...
		transferRects.add(new RecipeTransferRect(new Rectangle(21, 25, 18, 18), "polycraftmtufuel"));
		transferRects.add(new RecipeTransferRect(new Rectangle(84, 24, 24, 18), "meroxtreatmentunit"));
	}
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		...
		} else if (outputId.equals("meroxtreatmentunit")) {
	...
	public void loadCraftingRecipes(ItemStack result) {
		Collection<PolycraftRecipe> recipes = PolycraftMod.recipeManagerRuntime
				.getRecipesByContainerType(PolycraftContainerType.MEROX_TREATMENT_UNIT);
		for (PolycraftRecipe recipe : recipes) {
			if (checkOutput(recipe, result))
				arecipes.add(new MeroxTreatRecipe(recipe));
		}
	}
