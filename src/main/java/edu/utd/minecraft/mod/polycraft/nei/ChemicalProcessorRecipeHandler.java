...
/**
 * If anything end-game users spend a lot of time with Chemical Processors.
 * 
 * @author Cappycot
 *
 */
public class ChemicalProcessorRecipeHandler extends TemplateRecipeHandler {
	...
	public static final int[][] INPUT_POS = { { 3, 7 }, { 21, 7 }, { 39, 7 }, { 3, 25 }, { 39, 25 } };

	public class ChemProcRecipe extends CachedRecipe {
		...
		public ChemProcRecipe(PolycraftRecipe recipe) {
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		...
		} else if (outputId.equals("chemicalprocessor")) {
