...
public class CondenserBlock extends PolycraftInventoryBlock {
	...
	public CondenserBlock(final Inventory config, final Class tileEntityClass) {
	...
	private void func_149919_e(World p_149919_1_, int p_149919_2_, int p_149919_3_, int p_149919_4_)
	{
		...
		int i1 = CondenserInventory.getDirectionFromMetadata(l);
	...
	public static CondenserInventory func_149920_e(IBlockAccess p_149920_0_, int p_149920_1_, int p_149920_2_, int p_149920_3_)
	{
		return (CondenserInventory) p_149920_0_.getTileEntity(p_149920_1_, p_149920_2_, p_149920_3_);
	}
