...
public class Element extends Entity {
	...
	public Element(final String name, final String symbol, final int atomicNumber, final int group, final int period, final double weight, final double density, final double melt, final double boil, final double heat,
			final double electronegativity, final double abundance) {
		// this(name, symbol, atomicNumber, group, period, weight, density, melt, boil, heat, electronegativity, abundance);
