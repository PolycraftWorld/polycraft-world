...
public class PlasticChestLargeInventory implements IInventory
{
    /** Name of the chest. */
    private String name;
    ...
    public PlasticChestLargeInventory(String par1Str, IInventory par2IInventory, IInventory par3IInventory)
    {
        this.name = par1Str;
