...
public class PlayerExperimentEvent10 extends Event{
    ...
    public PlayerExperimentEvent10(int id1, int size1, int xPos1, int zPos1,World world1, int maxteams1, int teamsize1,String teamname, Float score)
    {
    	super();
