...
public class ContactPrinterRecipeHandler extends TemplateRecipeHandler {

	public static final int[][] INPUT_POS = { { 3, 7 }, { 57, 25 }, { 57, 7 }, { 57, 43 } };

	public class ConPrintRecipe extends CachedRecipe {
		...
		public ConPrintRecipe(PolycraftRecipe recipe) {
	...
	public void loadTransferRects() {
		...
		transferRects.add(new RecipeTransferRect(new Rectangle(21, 25, 18, 18), "polycraftcnpfuel"));
		transferRects.add(new RecipeTransferRect(new Rectangle(84, 24, 24, 18), "contactprinter"));
	}
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		...
		} else if (outputId.equals("contactprinter")) {
	...
	public void loadCraftingRecipes(ItemStack result) {
		Collection<PolycraftRecipe> recipes = PolycraftMod.recipeManagerRuntime
				.getRecipesByContainerType(PolycraftContainerType.CONTACT_PRINTER);
		for (PolycraftRecipe recipe : recipes) {
			if (checkOutput(recipe, result))
				arecipes.add(new ConPrintRecipe(recipe));
		}
	}
