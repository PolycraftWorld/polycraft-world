...
public class RenderChemicalProcessor implements ISimpleBlockRenderingHandler {
	public static final RenderChemicalProcessor INSTANCE = new RenderChemicalProcessor();
	...
	public int getRenderId() {
		return PolycraftMod.renderChemicalProcessorID;
	}
}
