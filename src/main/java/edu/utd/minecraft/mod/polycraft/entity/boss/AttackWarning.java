...
public class AttackWarning {
	...
	public AttackWarning(double x1, double z1, double x2, double z2, double y, double h, int warnTicks) {
	...
	public AttackWarning(double xc, double zc, double radius, double y, double h, int warnTicks) {
		this.x1 = xc - radius;
		this.z1 = zc - radius;
		this.x2 = xc + radius;
		this.z2 = zc + radius;
	...
	public static void renderAttackWarnings(Entity entity) {
		...
		if (dec)
			lastTicksExisted = entity.ticksExisted;
	}
}
