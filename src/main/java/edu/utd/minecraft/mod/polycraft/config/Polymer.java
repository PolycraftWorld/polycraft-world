...
public class Polymer extends Compound {
	...
	public static final Polymer plexiglass = (Polymer) registry.register(new Compound("Plexiglass (PMMA)", Plastic.getDefaultForType(0)));
	...
	public static final Polymer CDAP = (Polymer) registry.register(new Compound("Cellulose diacetate (CDAP)", Plastic.getDefaultForType(0)));
	// USES: (CDAP) cigarette filters, protective goggles, tool handles, oil gauges, toothbrushes and eyeglass frames
	public static final Polymer CTAP = (Polymer) registry.register(new Compound("Cellulose triacetate (CTAP)", Plastic.getDefaultForType(0)));
	// USES: (CTAP) clothes, ease of washing and drying, less wrinkling, graceful drape

	// polyolefins
	public static final Polymer PVDC = (Polymer) registry.register(new Compound("poly vinylidene dichloride (PVDC)", Plastic.getDefaultForType(0)));
	public static final Polymer PVAC = (Polymer) registry.register(new Compound("poly vinyl acetate (PVAC)", Plastic.getDefaultForType(0)));
	public static final Polymer PVA = (Polymer) registry.register(new Compound("poly vinyl alcohol (PVA)", Plastic.getDefaultForType(0)));
	public static final Polymer PVB = (Polymer) registry.register(new Compound("poly vinyl butyral (PVB)", Plastic.getDefaultForType(0)));
	public static final Polymer PVFo = (Polymer) registry.register(new Compound("poly vinyl formal (PVFo)", Plastic.getDefaultForType(0)));
	public static final Polymer PVME = (Polymer) registry.register(new Compound("poly vinyl methyl ether (PVME)", Plastic.getDefaultForType(0)));
	public static final Polymer PEEK = (Polymer) registry.register(new Compound("poly ether ether ketone (PEEK)", Plastic.getDefaultForType(0)));
	...
	public static final Polymer PMIA = (Polymer) registry.register(new Compound("poly m-phenylene isophthalamide (PMIA)", Plastic.getDefaultForType(0)));
	public static final Polymer PPO = (Polymer) registry.register(new Compound("poly phenylene oxide (PPO)", Plastic.getDefaultForType(0)));
	public static final Polymer PPS = (Polymer) registry.register(new Compound("poly p-phenylene sulphide (PPS)", Plastic.getDefaultForType(0)));
	public static final Polymer PPTA = (Polymer) registry.register(new Compound("poly p-phenylene terephthalamide (PPTA)", Plastic.getDefaultForType(0)));
	...
	public static final Polymer PHMA = (Polymer) registry.register(new Compound("poly hexamethylene adipamide (Nylon 6,6) (PHMA)", Plastic.getDefaultForType(0)));
	public static final Polymer PHMS = (Polymer) registry.register(new Compound("poly hexamethylene sebacamide (Nylon 6,10) (PHMS)", Plastic.getDefaultForType(0)));
	public static final Polymer PMMS = (Polymer) registry.register(new Compound("poly m-methyl styrene (PMMS)", Plastic.getDefaultForType(0)));
	public static final Polymer PPMS = (Polymer) registry.register(new Compound("poly p-methyl styrene (PPMS)", Plastic.getDefaultForType(0)));
	public static final Polymer POM = (Polymer) registry.register(new Compound("Poly oxymethylene (POM)", Plastic.getDefaultForType(0)));
	public static final Polymer PAN = (Polymer) registry.register(new Compound("polyacrylonitrile (PAN)", Plastic.getDefaultForType(0)));
	public static final Polymer PEG = (Polymer) registry.register(new Compound("polyethylene glycol (PEG)", Plastic.getDefaultForType(0)));
	public static final Polymer PPG = (Polymer) registry.register(new Compound("polypropylene glycol (PPG)", Plastic.getDefaultForType(0)));

	public static final Polymer polyol = (Polymer) registry.register(new Compound("polyol", Plastic.getDefaultForType(0)));
	public static final Polymer PI = (Polymer) registry.register(new Compound("polyimide (PI)", Plastic.getDefaultForType(0)));
	public static final Polymer epoxyResin = (Polymer) registry.register(new Compound("epoxy resin", Plastic.getDefaultForType(0)));
	public static final Polymer phenolicResin = (Polymer) registry.register(new Compound("phenolic resin (phenol formaldehydes)", Plastic.getDefaultForType(0)));
	// USES: (phenol-formaldehyde) darker in color... appliance handles, wood adhesives, particle board adhesive, exterior wood
	public static final Polymer UFP = (Polymer) registry.register(new Compound("urea-formaldehyde polymers (UFP)", Plastic.getDefaultForType(0)));
	// USES: (urea-formaldehyde) lighter in color... appliance handles, wood adhesives, particle board adhesive, interior wood
	public static final Polymer MFP = (Polymer) registry.register(new Compound("melamine-formaldehyde polymers (MFP)", Plastic.getDefaultForType(0)));
	// USES: (melamine-formaldehyde) lighter in color... decorative dinner ware, countertops, coatings

	public static final Polymer cellulosics = (Polymer) registry.register(new Compound("cellulosics", Plastic.getDefaultForType(0)));
	// USES: (cellulosics) cotton, flax, hemp, kapok, sisal, jute, ramie,
	public static final Polymer lignins = (Polymer) registry.register(new Compound("lignins", Plastic.getDefaultForType(0)));

	public static final Polymer polyphenol = (Polymer) registry.register(new Compound("polyphenol", Plastic.getDefaultForType(0)));
	...
	public static final Polymer PBT = (Polymer) registry.register(new Compound("poly butylene terephthalate", Plastic.getDefaultForType(0)));
	...
	public static final Polymer PEO = (Polymer) registry.register(new Compound("polyethylene oxide (PEO)", Plastic.getDefaultForType(0)));

	// degradable polyesters
	public static final Polymer PLLA = (Polymer) registry.register(new Compound("poly(l-lactic acid) (PLLA)", Plastic.getDefaultForType(0)));
	public static final Polymer PLGA = (Polymer) registry.register(new Compound("poly(lactic-co-glycolic acid) (PLGA)", Plastic.getDefaultForType(0)));
	public static final Polymer PHB = (Polymer) registry.register(new Compound(" poly-2-hydroxy butyrate (PHB)", Plastic.getDefaultForType(0)));
	public static final Polymer PCL = (Polymer) registry.register(new Compound(" polycaprolactone (PCL)", Plastic.getDefaultForType(0)));

	// alkyd resins - network polyesters - dicarboxylic acids or their anhydrides and polyfunctional alcohols such as glycerol
	public static final Polymer alkydResins = (Polymer) registry.register(new Compound("Alkyd Resins", Plastic.getDefaultForType(0)));
	...
	public static final Polymer SAN = (Polymer) registry.register(new Compound("styrene-acrylonitrile (SAN)", Plastic.getDefaultForType(0)));
	// USES: (SAN) battery cases, automotive parts, kitchen ware, appliances, furniture, medical supplies
	public static final Polymer SMAC = (Polymer) registry.register(new Compound("styrene-maleic anhydride copolymer (SMAC)", Plastic.getDefaultForType(0)));
	// USES: (SMAC) food service trays

	// fluoropolymers
	public static final Polymer PTFE = (Polymer) registry.register(new Compound("polytetrafluoroethylene", Plastic.getDefaultForType(0)));
	public static final Polymer PVDF = (Polymer) registry.register(new Compound("poly vinylidene fluoride (PVDF)", Plastic.getDefaultForType(0)));
	public static final Polymer PVDF_TrFE = (Polymer) registry.register(new Compound("poly vinylidene fluoride-trifluoroethylene (PVDF-TrFE)", Plastic.getDefaultForType(0)));
	public static final Polymer PCTFE = (Polymer) registry.register(new Compound("poly chlorotrifluoroethylene (PCTFE)", Plastic.getDefaultForType(0)));
	public static final Polymer PVF = (Polymer) registry.register(new Compound("poly vinyl fluoride (PVF)", Plastic.getDefaultForType(0)));

	// acrylic polymers
	public static final Polymer PMA = (Polymer) registry.register(new Compound("poly(methyl acrylate) (PMA)", Plastic.getDefaultForType(0)));
	public static final Polymer PMMA = (Polymer) registry.register(new Compound("poly(methyl methacrylate) (PMMA)", Plastic.getDefaultForType(0)));
	public static final Polymer PEA = (Polymer) registry.register(new Compound("poly(ethyl acrylate) (PeA)", Plastic.getDefaultForType(0)));
	public static final Polymer PnBA = (Polymer) registry.register(new Compound("poly(n-butyl acrylate) (PnBA)", Plastic.getDefaultForType(0)));
	public static final Polymer PtBA = (Polymer) registry.register(new Compound("poly(tert-butyl acrylate) (PtBA)", Plastic.getDefaultForType(0)));
	public static final Polymer PiBA = (Polymer) registry.register(new Compound("poly(iso-butyl acrylate) (PiBA)", Plastic.getDefaultForType(0)));
	public static final Polymer PIBoA = (Polymer) registry.register(new Compound("poly(iso-borynl acrylate) (PIBoA)", Plastic.getDefaultForType(0)));
	public static final Polymer P2HEMA = (Polymer) registry.register(new Compound("poly 2-hydroxyethyl methacrylate (PHEMA)", Plastic.getDefaultForType(0)));
	public static final Polymer PMCA = (Polymer) registry.register(new Compound("poly methyl cyanoacrylate (PMCA)", Plastic.getDefaultForType(0)));
	public static final Polymer polyacrylateElastomers = (Polymer) registry.register(new Compound("polyacrylate elastomers", Plastic.getDefaultForType(0)));

	// diene polymers
	public static final Polymer PChl = (Polymer) registry.register(new Compound("polychloroprene (PChl)", Plastic.getDefaultForType(0)));
	public static final Polymer polyisoprene = (Polymer) registry.register(new Compound("natural rubber (polyisoprene)", Plastic.getDefaultForType(0)));
	public static final Polymer polybutadiene = (Polymer) registry.register(new Compound("polybutadiene", Plastic.getDefaultForType(0)));
	public static final Polymer PBR = (Polymer) registry.register(new Compound("polybutadiene rubber (PBR)", Plastic.getDefaultForType(0)));
	public static final Polymer ABS = (Polymer) registry.register(new Compound("acrylonitrile-butadiene-styrene (ABS)", Plastic.getDefaultForType(0)));
	public static final Polymer SBR = (Polymer) registry.register(new Compound("styrene-butadiene rubber (SBR)", Plastic.getDefaultForType(0)));
	...
	public static final Polymer NBR = (Polymer) registry.register(new Compound("nitrile-butadiene rubber (NBR)", Plastic.getDefaultForType(0)));
	public static final Polymer HNBR = (Polymer) registry.register(new Compound("hydrogenated nitrile-butadiene rubber (HNBR)", Plastic.getDefaultForType(0)));

	// isobutylene rubbers - USES: rubber tires, bladders, innertubes, anything to hold hot steam
	public static final Polymer PIB = (Polymer) registry.register(new Compound("poly isobutylene (PIB)", Plastic.getDefaultForType(0)));
	public static final Polymer IIR = (Polymer) registry.register(new Compound("isobutylene-isoprene rubber (IIR)", Plastic.getDefaultForType(0)));
	public static final Polymer BIIR = (Polymer) registry.register(new Compound("bromine isobutylene-isoprene rubber (BIIR)", Plastic.getDefaultForType(0)));
	public static final Polymer CIIR = (Polymer) registry.register(new Compound("chlorine isobutylene-isoprene rubber (CIIR)", Plastic.getDefaultForType(0)));

	// styrene block copolymers - USES: hot melt adhesives, shoes and to improve bitumen
	// public static final Polymer SBR = (Polymer) registry.register(new Compound("styrene-butadiene rubber (SBR)", Plastic.getDefaultForType(0)));
	// public static final Polymer ABS = (Polymer) registry.register(new Compound("acrylonitrile-butadiene-styrene (ABS)", Plastic.getDefaultForType(0)));
	public static final Polymer SBS = (Polymer) registry.register(new Compound("styrene-butadiene-styrene (SBS)", Plastic.getDefaultForType(0)));
	public static final Polymer SIS = (Polymer) registry.register(new Compound("styrene-isoprene-styrene (SIS)", Plastic.getDefaultForType(0)));
	...
	public static final Polymer EPM = (Polymer) registry.register(new Compound("ethylene-propylene monomer (EPM)", Plastic.getDefaultForType(0)));
	public static final Polymer EPDM = (Polymer) registry.register(new Compound("ethylene-propylene-diene monomer (EPM)", Plastic.getDefaultForType(0)));
