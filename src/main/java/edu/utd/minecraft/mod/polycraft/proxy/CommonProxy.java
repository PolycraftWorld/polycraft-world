...
public class CommonProxy {
	...
	private void createCustomItems() {
		...
		PolycraftMod.itemScubaFlippers = PolycraftMod.registerItem("scuba_flippers", new ItemScubaFlippers(PolycraftMod.itemScubaFlippersSwimSpeedBuff, PolycraftMod.itemScubaFlippersWalkSpeedBuff));
