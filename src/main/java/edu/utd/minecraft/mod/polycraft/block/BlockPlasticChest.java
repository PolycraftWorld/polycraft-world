...
import edu.utd.minecraft.mod.polycraft.tileentity.TileEntityPlasticChest;
...
public class BlockPlasticChest extends BlockContainer
{
    ...
    protected BlockPlasticChest(int p_i45397_1_)
    {
        super(Material.wood);
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityPlasticChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntityPlasticChest tileentityplasticchest = (TileEntityPlasticChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);

        if (tileentityplasticchest != null)
        {
        	tileentityplasticchest.updateContainingBlockInfo();
        }
    }

    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        TileEntityPlasticChest tileentityplasticchest = (TileEntityPlasticChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

        if (tileentityplasticchest != null)
        {
            for (int i1 = 0; i1 < tileentityplasticchest.getSizeInventory(); ++i1)
            {
                ItemStack itemstack = tileentityplasticchest.getStackInSlot(i1);
    ...
    {
        Object object = (TileEntityPlasticChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
        ...
        else
        {
            ...
            {
                object = new PlasticChestLargeInventory("container.chestDouble", (TileEntityPlasticChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
            {
                object = new PlasticChestLargeInventory("container.chestDouble", (IInventory)object, (TileEntityPlasticChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
            {
                object = new PlasticChestLargeInventory("container.chestDouble", (TileEntityPlasticChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
            {
                object = new PlasticChestLargeInventory("container.chestDouble", (IInventory)object, (TileEntityPlasticChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
            }
    ...
    {
        TileEntityPlasticChest tileentityplasticchest = new TileEntityPlasticChest();
        return tileentityplasticchest;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_)
    {
        ...
        {
            int i1 = ((TileEntityPlasticChest)p_149709_1_.getTileEntity(p_149709_2_, p_149709_3_, p_149709_4_)).numPlayersUsing;
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("polymer_yellow");
    }
}