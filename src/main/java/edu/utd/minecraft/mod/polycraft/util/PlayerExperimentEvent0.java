...
public class PlayerExperimentEvent0 extends Event{
    ...
    public PlayerExperimentEvent0(int id1, int size1, int xPos1, int zPos1,World world1, int maxteams1, int teamsize1, EntityPlayer player, String playername)
    {
    	super();
