...
public class InjectionMolderRecipeHandler extends TemplateRecipeHandler {

	public class InjectMoldRecipe extends CachedRecipe {
		...
		public InjectMoldRecipe(PolycraftRecipe recipe) {
	...
	public void loadTransferRects() {
		...
		transferRects.add(new RecipeTransferRect(new Rectangle(126, 44, 20, 18), "injectionmolder"));
	}
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		...
		} else if (outputId.equals("injectionmolder")) {
	...
	public void loadCraftingRecipes(ItemStack result) {
		Collection<PolycraftRecipe> recipes = PolycraftMod.recipeManagerRuntime
				.getRecipesByContainerType(PolycraftContainerType.INJECTION_MOLDER);
		for (PolycraftRecipe recipe : recipes) {
			if (checkOutput(recipe, result))
				arecipes.add(new InjectMoldRecipe(recipe));
		}
	}
	...
	public String getGuiTexture() {
		...
		return PolycraftMod.getAssetNameString("textures/gui/container/injection_molder.png");
	}

	@Override
	public String getOverlayIdentifier() {
		return "injectionmolder";
	}
